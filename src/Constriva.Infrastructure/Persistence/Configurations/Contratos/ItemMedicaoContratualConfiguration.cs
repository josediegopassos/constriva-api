...
public class ItemMedicaoContratualConfiguration : IEntityTypeConfiguration<ItemMedicaoContratual>
{
    public void Configure(EntityTypeBuilder<ItemMedicaoContratual> b)
    {
        b.ToTable("ItensMedicaoContratual");
        b.HasKey(e => e.Id);
