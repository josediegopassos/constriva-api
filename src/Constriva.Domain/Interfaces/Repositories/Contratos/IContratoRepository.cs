...
{
    Task<Contrato?> GetByIdComDetalhesAsync(Guid id, Guid empresaId, CancellationToken ct = default);
    ...
    Task<IEnumerable<MedicaoContratual>> GetTodasMedicoesAsync(Guid empresaId, CancellationToken ct = default);
