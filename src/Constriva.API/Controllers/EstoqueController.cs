...
namespace Constriva.API.Controllers
{
    ...
    public sealed class EstoqueController : BaseController
    {
        ...
        public async Task<IActionResult> CreateMaterial([FromBody] CreateMaterialDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new CreateMaterialCommand(RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> UpdateMaterial(Guid id, [FromBody] UpdateMaterialDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new UpdateMaterialCommand(id, RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> DeleteMaterial(Guid id, CancellationToken ct)
        {
            try
            {
                await Mediator.Send(new DeleteMaterialCommand(id, RequireEmpresaId()), ct);
                return NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> CreateAlmoxarifado([FromBody] CreateAlmoxarifadoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new CreateAlmoxarifadoCommand(RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> UpdateAlmoxarifado(Guid id, [FromBody] UpdateAlmoxarifadoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new UpdateAlmoxarifadoCommand(id, RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> DeleteAlmoxarifado(Guid id, CancellationToken ct)
        {
            try
            {
                await Mediator.Send(new DeleteAlmoxarifadoCommand(id, RequireEmpresaId()), ct);
                return NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeleteMovimentacao(Guid id, CancellationToken ct)
        {
            try
            {
                await Mediator.Send(new DeleteMovimentacaoCommand(id, RequireEmpresaId()), ct);
                return NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> CreateMovimentacao([FromBody] CreateMovimentacaoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new CreateMovimentacaoCommand(RequireEmpresaId(), CurrentUser.UserId, dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> CreateRequisicao([FromBody] CreateRequisicaoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new CreateRequisicaoCommand(RequireEmpresaId(), CurrentUser.UserId, dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> UpdateRequisicao(Guid id, [FromBody] UpdateRequisicaoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new UpdateRequisicaoCommand(id, RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> DeleteRequisicao(Guid id, CancellationToken ct)
        {
            try
            {
                await Mediator.Send(new DeleteRequisicaoCommand(id, RequireEmpresaId()), ct);
                return NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> AddItemRequisicao(Guid id, [FromBody] AddItemRequisicaoDto dto, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new AddItemRequisicaoCommand(id, RequireEmpresaId(), dto), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> AprovarRequisicao(Guid id, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new AprovarRequisicaoCommand(id, RequireEmpresaId(), CurrentUser.UserId), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> AtenderRequisicao(Guid id, [FromBody] IEnumerable<AtenderItemDto> itens, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new AtenderRequisicaoCommand(id, RequireEmpresaId(), CurrentUser.UserId, itens), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> ReprovarRequisicao(Guid id, [FromBody] ReprovarRequisicaoRequest body, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new ReprovarRequisicaoCommand(id, RequireEmpresaId(), CurrentUser.UserId, body.Motivo), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
        ...
        public async Task<IActionResult> CancelarRequisicao(Guid id, [FromBody] CancelarRequisicaoRequest body, CancellationToken ct)
        {
            try
            {
                return Ok(await Mediator.Send(new CancelarRequisicaoCommand(id, RequireEmpresaId(), CurrentUser.UserId, body.Motivo), ct));
            }
            catch (Exception ex)
            {
                return HandleException(ex);
